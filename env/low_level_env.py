...
class Testing_Env(gym.Env):
    ...
    def reset(self):
        ...
        return self.single_state, self.trend_state, self.minute1_state, self.minute3_state, self.minute5_state, self.terminal, {
            "previous_action": self.initial_action,
        }
    ...
    def step(self, action):
        ...
        return self.single_state, self.trend_state, self.minute1_state, self.minute3_state, self.minute5_state, self.reward, self.terminal, {
...
class Training_Env(Testing_Env):
    def __init__(
        ...
        super(Training_Env,
              self).__init__(df, tech_indicator_list, tech_indicator_list_trend, minute1_indicator_list, minute3_indicator_list, minute5_indicator_list, transcation_cost,
    ...
    def reset(self):
        single_state, trend_state, minute1_state, minute3_state, minute5_state, done, info = super(Training_Env, self).reset()
        self.previous_action = self.initial_action
        self.previous_position = self.initial_action * self.max_holding_number
        self.position = self.initial_action * self.max_holding_number
        info['q_value'] = self.q_table[self.m - 1][self.previous_action][:]
        return single_state, trend_state, minute1_state, minute3_state, minute5_state, done, info

    def step(self, action):
        single_state, trend_state, minute1_state, minute3_state, minute5_state, reward, done, info = super(Training_Env, self).step(action)
        info['q_value'] = self.q_table[self.m - 1][action][:]
        return single_state, trend_state, minute1_state, minute3_state, minute5_state, reward, done, info
